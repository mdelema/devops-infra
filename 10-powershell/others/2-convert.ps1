param (
    [string]$pdfFolder = "E:\Satelites\portada-impresa\temp",  # Carpeta con PDFs
    [string]$outputFolder = "E:\Satelites\portada-impresa\temp",  # Carpeta para JPGs
    [string]$magickPath = "C:\Program Files\ImageMagick-7.1.1-Q16-HDRI\magick.exe"
    #[string]$exePath = "E:\Satelites\portada-impresa\PDFtoJPG.exe"
)
